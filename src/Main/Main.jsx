        ...
        <div className="flex justify-between mb-3">
          {deletedImg.length === 0 ? (
            ...
            <div className="flex justify-center items-center gap-1">
              ...
              <p className="text-lg md:text-[17px] text-pink-500 uppercase font-semibold">
                Image Selected: <span className="text-black">{deletedImg.length}</span>
              </p>
            </div>
          )}
          <Button
        ...
        >
          <SortableContext items={items} strategy={rectSortingStrategy}>
            {items?.length !== 0 ? (
              ...
              <div>
                {" "}
                <h2 className="text-5xl text-red-600 animate-pulse font-bold uppercase my-40 text-center">
                  Reload the page
                </h2>
              </div>
            )}
